  ...
  Widget build(BuildContext context) => Scaffold(
        body: Container(
            ...
            child: PageView(
                ...
                children: [
                  buildPage(urlImage: 'assets/images/icons/Welcome.png'),
                  buildPage(urlImage: 'assets/images/icons/1TapAnywhere.png'),
                  buildPage(
                      urlImage: 'assets/images/icons/2PinnedLocDisplay.png'),
                  buildPage(urlImage: 'assets/images/icons/3PinnedLoc.png'),
                  buildPage(urlImage: 'assets/images/icons/4PinnedLoc.png'),
                  buildPage(urlImage: 'assets/images/icons/5PinnedLoc.png'),
                  buildPage(
                    urlImage: 'assets/images/icons/6PinnedLoc.png',
                  ),
                  buildPage(urlImage: 'assets/images/icons/7PinnedLoc.png'),
                  buildPage(
